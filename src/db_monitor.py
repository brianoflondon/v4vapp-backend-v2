...
from v4vapp_backend_v2.helpers.opening_balances import reset_lightning_opening_balance
...
if __name__ == "__main__":
    try:
        ...
        logger.error("🔴 Unhandled exception in db_monitor", exc_info=e, stack_info=True)
