...
class _ResolveHoldForwardActionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ResolveHoldForwardAction.ValueType], builtins.type):
    ...
    RESUME_MODIFIED: _ResolveHoldForwardAction.ValueType  # 3
...
"""RESUME is an action that is used to resume a forward HTLC."""
RESUME_MODIFIED: ResolveHoldForwardAction.ValueType  # 3
"""RESUME_MODIFIED is an action that is used to resume a hold forward HTLC
with modifications specified during interception.
"""
...
class SendPaymentRequest(google.protobuf.message.Message):
    ...
    @typing.final
    class FirstHopCustomRecordsEntry(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    FIRST_HOP_CUSTOM_RECORDS_FIELD_NUMBER: builtins.int
    dest: builtins.bytes
    ...
    @property
    def first_hop_custom_records(self) -> google.protobuf.internal.containers.ScalarMap[builtins.int, builtins.bytes]:
        """
        An optional field that can be used to pass an arbitrary set of TLV records
...
class SendToRouteRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["first_hop_custom_records", b"first_hop_custom_records", "payment_hash", b"payment_hash", "route", b"route", "skip_temp_err", b"skip_temp_err"]) -> None: ...
...
class BuildRouteRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["amt_msat", b"amt_msat", "final_cltv_delta", b"final_cltv_delta", "first_hop_custom_records", b"first_hop_custom_records", "hop_pubkeys", b"hop_pubkeys", "outgoing_chan_id", b"outgoing_chan_id", "payment_addr", b"payment_addr"]) -> None: ...
...
class ForwardHtlcInterceptRequest(google.protobuf.message.Message):
    ...
    @typing.final
    class InWireCustomRecordsEntry(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    IN_WIRE_CUSTOM_RECORDS_FIELD_NUMBER: builtins.int
    ...
    @property
    def in_wire_custom_records(self) -> google.protobuf.internal.containers.ScalarMap[builtins.int, builtins.bytes]:
...
class ForwardHtlcInterceptResponse(google.protobuf.message.Message):
    ...
    @typing.final
    class OutWireCustomRecordsEntry(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    IN_AMOUNT_MSAT_FIELD_NUMBER: builtins.int
    OUT_AMOUNT_MSAT_FIELD_NUMBER: builtins.int
    OUT_WIRE_CUSTOM_RECORDS_FIELD_NUMBER: builtins.int
    ...
    @property
    def out_wire_custom_records(self) -> google.protobuf.internal.containers.ScalarMap[builtins.int, builtins.bytes]:
    ...
    def __init__(
        ...
        *,
        ...
        in_amount_msat: builtins.int = ...,
        out_amount_msat: builtins.int = ...,
        out_wire_custom_records: collections.abc.Mapping[builtins.int, builtins.bytes] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["incoming_circuit_key", b"incoming_circuit_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["action", b"action", "failure_code", b"failure_code", "failure_message", b"failure_message", "in_amount_msat", b"in_amount_msat", "incoming_circuit_key", b"incoming_circuit_key", "out_amount_msat", b"out_amount_msat", "out_wire_custom_records", b"out_wire_custom_records", "preimage", b"preimage"]) -> None: ...
...
@typing.final
class AddAliasesRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    ALIAS_MAPS_FIELD_NUMBER: builtins.int
    @property
    def alias_maps(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[lightning_pb2.AliasMap]: ...
    def __init__(
        self,
        *,
        alias_maps: collections.abc.Iterable[lightning_pb2.AliasMap] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["alias_maps", b"alias_maps"]) -> None: ...

global___AddAliasesRequest = AddAliasesRequest

@typing.final
class AddAliasesResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___AddAliasesResponse = AddAliasesResponse

@typing.final
class DeleteAliasesRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___DeleteAliasesRequest = DeleteAliasesRequest

@typing.final
class DeleteAliasesResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___DeleteAliasesResponse = DeleteAliasesResponse
